  ...
  return (
    <div className={`relative ${containerClassName}`}>
      <input
        ...
        className={`${className} font-poppins block pl-2.5 pb-2.5 pt-4 pr-12 w-full text-lg text-white bg-transparent rounded-lg border-2 appearance-none focus:outline-none focus:ring-0 peer transition-colors focus:border-sky-500 border-gray-500`}
        defaultValue={value || ""}
        onChange={onChange}
        readOnly={readonly}
        name={name}
